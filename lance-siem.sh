...
suricata-update
'
docker run --net evebox -d --net=host -it jasonish/evebox:latest -e http://127.0.0.1:9200 -i 'logstash*'


docker run -d --name kibana --network=elasticsearch -p 5601:5601 docker.elastic.co/kibana/kibana:8.0.0 
sleep 60
